...
import { FaGamepad, FaSignOutAlt, FaSearch, FaBell, FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn, FaWhatsapp, FaYoutube } from "react-icons/fa";
import axios from "axios";

// Navbar Component
const Navbar = ({ notifications, onLogout, onToggleNotifications, isNotificationsOpen, onMarkAsRead }) => {
    ...
    <nav className="bg-gradient-to-r from-[#111827] to-[#374151] shadow-md fixed w-full z-50">
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="md:hidden flex items-center">
          <button onClick={onToggleNotifications} className="text-white">
            <FaBell className="text-2xl" />
            {unreadCount > 0 && (
              <span className="absolute top-0 right-0 bg-[#4ADE80] text-white text-xs rounded-full px-2 py-1">
                {unreadCount}
